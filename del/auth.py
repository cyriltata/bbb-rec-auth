...
import psycopg2
conn_auth = psycopg2.connect("dbname=greenlight_production user=postgres password=9e5ce7e3907280fa host=localhost")
...
def get_credentials(environ):
	...
	credentials = base64.decodebytes(http_auth).decode('ascii')
